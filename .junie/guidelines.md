...
- Runner and scripts
  - Tests are TypeScript files under src/**tests**.
  - npm test runs: tsc && node --test dist/**tests**/\*.js.
...
- Mocks/utilities
  - src/**tests**/testUtils.ts exports installFetchMock() which shims globalThis.fetch to work with new URL('
...
- Adding a new test (example)
  - Create a new file in src/**tests**/myFeature.test.ts:
